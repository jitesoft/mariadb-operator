...
[CustomResourceDefinition("database.jitesoft.tech", "v1alpha1", "mariadbs")]
public class MariaDB : CustomResource<MariaDB.MariaDBSpec, MariaDB.MariaDBStatus>
{
    ...
    public class MariaDBStatus
    {
        ...
        public int CurrentState { get; set; } = (int)MariaDBOperator.Status.Unknown;

        [Newtonsoft.Json.JsonIgnore]
        public Status CurrentStateEnum
        {
